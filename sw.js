const C='zarha-booth-v22';
self.addEventListener('install',e=>{e.waitUntil(caches.open(C).then(c=>c.addAll(['./','./index.html','./eds.html','./carra.html','./manifest.webmanifest','./icon-180.png','./icon-512.png'])));self.skipWaiting();});
